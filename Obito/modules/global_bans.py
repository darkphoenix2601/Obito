...
import Obito.modules.sql.global_bans_sql as sql
from Obito.modules.sql.users_sql import get_user_com_chats
from Obito import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from Obito.modules.helper_funsc.misc import send_to_list
