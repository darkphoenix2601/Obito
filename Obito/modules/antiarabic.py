...
from Obito.modules.helper_funsc.chat_status import user_not_admin, user_admin, can_delete
from Obito.modules.helper_funsc.extraction import extract_text
from Obito.modules.sql import antiarabic_sql as sql
...
⚠️️ NOTE: AntiArabicScript module doesn't affect messages sent by admins.
Admin only:
