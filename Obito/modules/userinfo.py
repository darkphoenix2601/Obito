...
from Obito.__main__ import STATS, TOKEN, USER_INFO
import Obito.modules.sql.userinfo_sql as sql
from Obito.modules.disable import DisableAbleCommandHandler
from Obito.modules.sql.global_bans_sql import is_user_gbanned
from Obito.modules.sql.afk_sql import is_afk, check_afk_status
from Obito.modules.sql.users_sql import get_user_num_chats
from Obito.modules.helper_funsc.chat_status import sudo_plus
from Obito.modules.helper_funsc.extraction import extract_user
from Obito import telethn as YoneTelethonClient, TIGERS, DRAGONS, DEMONS
...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        text += ' [<a href="https://t.me/Obito_updates/8">?</a>]'.format(
            bot.username
        )
