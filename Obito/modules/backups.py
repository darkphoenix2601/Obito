...
import Obito.modules.sql.notes_sql as sql
from Obito import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from Obito.__main__ import DATA_IMPORT
from Obito.modules.helper_funsc.chat_status import user_admin
from Obito.modules.helper_funsc.alternate import typing_action

# from Obito.modules.rules import get_rules
import Obito.modules.sql.rules_sql as rulessql

# from Obito.modules.sql import warns_sql as warnssql
import Obito.modules.sql.blacklist_sql as blacklistsql
from Obito.modules.sql import disable_sql as disabledsql

# from Obito.modules.sql import cust_filters_sql as filtersql
# import Obito.modules.sql.welcome_sql as welcsql
import Obito.modules.sql.locks_sql as locksql
from Obito.modules.connection import connected
...
def export_data(update, context):
    ...
    with open("Obito{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("Obito{}.backup".format(chat_id), "rb"),
        caption="💾*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Obito-Backup` was specially made for notes 📚.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("Obito{}.backup".format(chat_id))  # Cleaning file
