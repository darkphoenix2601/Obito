...
from Obito import BOT_USERNAME, OWNER_ID
from Obito.conf import get_str_key
from Obito.more.pluginhelpers import convert_seconds_to_minutes as time_convert
from Obito.more.pluginhelpers import fetch
from Obito.pyrogramee.pyrogram import pbot
from Obito import arq
...
async def inline_help_func(__help__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/c95baa6fe2851d56fae30.jpg",
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main Bot", url="https://t.me/InukaRanmira_bot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/InukaRanmira_bot)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
