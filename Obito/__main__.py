...
from Obito.modules import ALL_MODULES
from Obito.modules.helper_funsc.chat_status import is_user_admin
from Obito.modules.helper_funsc.misc import paginate_modules
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="𝘜𝘱𝘥𝘢𝘵𝘦𝘴🤞", url=f"https://t.me/KTG_Updates"
        ),
        InlineKeyboardButton(
            text="𝘚𝘶𝘱𝘱𝘰𝘳𝘵😍", url=f"https://t.me/KTG_Support"
        ),
    ],
    [
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Obito.modules." + module_name)
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_photo(
            Obito_IMG, caption= "I'm awake already!\n<b>Haven't slept since:</b> <code>{}</code>".format(
                uptime
            ),
            parse_mode=ParseMode.HTML,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Sᴜᴘᴘᴏʀᴛ", url="https://t.me/KTG_SUPPORT")]]
            ),
        )
...
@run_async
def Obito_about_callback(update, context):
    query = update.callback_query
    if query.data == "Obito_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Setup Guide", callback_data="Obito_aselole"
                        ),
                        InlineKeyboardButton(
                            text="T & C", callback_data="Obito_puqi"
                        ),
                    ],
                    [InlineKeyboardButton(text="ʙᴀᴄᴋ", callback_data="Obito_back")],
                ]
            ),
        )
        ...
        query.message.edit_text(
            ...
            f"4.) add @ObitoAssistant to your group or type /join to invite her.\n"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="📗 Basic CMD", callback_data="Obito_admin"),
                    InlineKeyboardButton(text="📘 Advanced CMD", callback_data="Obito_notes"),
                 ],
                 [
                    InlineKeyboardButton(text="📙 Admin CMD", callback_data="Obito_support"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="Obito_back"),
        ...
        query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Back", callback_data="Obito_basichelp")]]
            ),
        )
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    ...
                    InlineKeyboardButton(text="Obito", url="https://t.me/tdrki_1"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="Obito_basichelp"),
        ...
        query.message.edit_text(
            text=f"｢ Setup Guide 」\n"
                 ...
                 f"\nIf you do need help with further instructions feel free to ask in @ObitoXresso.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Admins Permissions", callback_data="Obito_asu"),
                    InlineKeyboardButton(text="Anti Spam", callback_data="Obito_asi"),
                 ],
                 [
                    InlineKeyboardButton(text="Back", callback_data="Obito_"),
    ...
    elif query.data == "Obito_asu":
        query.message.edit_text(
            text=f"｢ Admin Permissions 」\n"
                     f"\nTo avoid slowing down, Obito caches admin rights for each user. This cache lasts about 10 minutes; this may change in the future. This means that if you promote a user manually (without using the /promote command), Obito will only find out ~10 minutes later.\n"
                    f"\nIf you want to update them immediately, you can use the /admincache or /reload command, that'll force Obito to check who the admins are again and their permissions\n"
                    f"\nIf you are getting a message saying:\nYou must be this chat administrator to perform this action!\n"
                    f"\nThis has nothing to do with Obito's rights; this is all about YOUR permissions as an admin. Obito respects admin permissions; if you do not have the Ban Users permission as a telegram admin, you won't be able to ban users with Obito. Similarly, to change Obito settings, you need to have the Change group info permission.\n"
                    f"\nThe message very clearly states that you need these rights - not Obito.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="Back", callback_data="Obito_aselole")]]
            ),
        )
 
    elif query.data == "Obito_asi":
        query.message.edit_text(
            text=f"｢ Anti-Spam Settings 」\n"
                     f"\nAntispam: "
                     f"\nBy enabling this, you can protect your groups free from scammers/spammers.\nRun /antispam on in your chat to enable.\nAppeal Chat: @ObitoXresso\n"
        ...
        query.message.edit_text(
            text=f" ｢ Terms and Conditions 」\n"
                ...
                f"\n✪ If you need to ask anything about this bot or you need help, reach us at @ObitoXresso"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                     InlineKeyboardButton(text="Credits", callback_data="Obito_angjay"),
                     InlineKeyboardButton(text="Back", callback_data="Obito_"),
                  ]
                ]
            ),
    ...
    elif query.data == "Obito_angjay":
        query.message.edit_text(
            text=f"Obito is a powerful bot for managing groups with additional features.\n"
              f"\nObito's Licensed Under The GNU (General Public License v3.0)\n"
              f"\nIf you have any question about Obito,"
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                  [
                     InlineKeyboardButton(text="Back", callback_data="Obito_puqi"),
                     InlineKeyboardButton(text="☎️ Support", url=f"https://t.me/KTG_SUPPORT"),
                  ]
                ]
            ),
        )   
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(Obito_about_callback, pattern=r"Obito_")
